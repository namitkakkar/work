...
class SampleViewModel {
  ...
  public operation: ko.Observable<String> = ko.observable("C");;
  ...
  // next task 
  public openActivityPopUp() {
    // alert("hello");
    let popup = document.getElementById('activityPopUp') as ojPopup;
    popup.open('#addbutton');
  }

  public saveListener = (event) => {
    ...
    if (this.operation() == "C") {
      ...
      this.rowData().DepartmentId = this.inputDepartmentId();
